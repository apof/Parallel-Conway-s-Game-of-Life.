...
int main(int argc, char **argv)
{
	...
	//if(myid==0)	 printf("P:%d My neighbors are r: %d d:%d 1:%d u:%d u_r:%d u_l:%d d_r:%d d_l:%d\n",myid,right,down,left,up,up_right,up_left,down_right,down_left);
